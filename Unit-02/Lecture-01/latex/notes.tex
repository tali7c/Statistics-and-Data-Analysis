...
\subsection*{Multi-Dimensional Categorical Example}
\small
...
\subsection*{Exercise Solution (Summary)}
\small
...
\begin{tabular}{lccc}
    ...
    \bottomrule
  \end{tabular}
\subsection*{Outlier Effect (Step 1)}
\small
...
\subsection*{Outlier Effect (Step 2)}
\begin{itemize}
